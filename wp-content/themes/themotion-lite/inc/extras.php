						...
						<div class="carousel-inner">
							...
							if ( $the_query->have_posts() ) {
								while ( $the_query->have_posts() ) {
									$the_query->the_post();
									$id = get_the_ID(); ?>
									<div class="item slide-number-<?php echo esc_attr( $id ); ?> <?php if ( 'false' == $active_was_set ) {echo 'active';
										$active_was_set = 'true'; } ?>" >
										<?php
										if ( has_post_format( 'video',$id ) ) {
											$post = get_post( $id );
				...
				<div class="themotion-playlist-tracks" id="slider-thumbs">
					...
					if ( $the_query->have_posts() ) {
						...
						while ( $the_query->have_posts() ) {
							...
							<div class="themotion-playlist-item <?php if ( 'true' == $first ) {echo 'themotion-playlist-playing';
								$first = 'false';}?>" id="carousel-selector-<?php echo esc_attr( $id ); ?>" data-id="<?php echo esc_attr( $id ); ?>">
								<?php
								if ( has_post_thumbnail() ) {
