...
if ( ! class_exists( 'Themotion_Control_Upsell' ) ) :
	/**
	 * Class Themotion_Control_Upsell
	 */
	class Themotion_Control_Upsell extends WP_Customize_Control {
		...
		/**
		 * Themotion_Control_Upsell constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Themotion_Control_Upsell' );
