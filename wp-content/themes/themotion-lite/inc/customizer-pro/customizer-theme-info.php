...
function themotion_theme_info_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'themotion_features_section', array(
	...
	// Add upsells.
	$wp_customize->add_setting( 'themotion_upsell_pro_features_main', array(
		'sanitize_callback' => 'esc_html',
	) );

	$wp_customize->add_control( new Themotion_Control_Upsell( $wp_customize, 'themotion_upsell_pro_features_main', array(
