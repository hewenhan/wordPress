...
(function (root, CP_Customizer, $) {
    ...
    CP_Customizer.addModule(function (CP_Customizer) {
        ...
        function getColorComponent() {
            ...
            var colorPallete = root.CP_Customizer.data().bgColorPallete;
                            ...
                            var itemData = {
                                ...
                                'on_click': function (node) {
                                    ...
                                    var _class = "cp" + columns + 'cols',
                                        colsRegexp = /(cp[0-9]+cols)(\s|$)/,
                                        currentDevice = root.CP_Customizer.preview.currentDevice();

                                    switch (currentDevice) {
                                        case "tablet":
                                            colsRegexp = /(cp[0-9]+cols\-tablet)(\s|$)/;
                                            _class += "-tablet";
                                            break;

                                        // case "mobile":
                                        //     colsRegexp = /(cp[0-9]+cols\-mobile)(\s|$)/;
                                        //     _class += "-mobile";
                                        //     break;
                                    }
                                    ...
                                    $(node).children().each(function (index, el) {
                                        ...
                                        _classAttr = _classAttr.replace(colsRegexp, "$2");
