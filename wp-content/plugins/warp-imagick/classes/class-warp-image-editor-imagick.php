					...
					try {
						...
						if ( is_callable( array( $this->image, 'sharpenImage' ) ) ) {
							...
							&& $this->image->getImageHeight() === $orig_size['height'] ) {
								...
								$jpeg_sharpen_sigma = Shared::get_option( 'jpeg-sharpen-image', Shared::jpeg_sharpen_image_default() );
								0 === $jpeg_sharpen_sigma || $this->image->sharpenImage( 0, $jpeg_sharpen_sigma / 10.0 );
							} else {

								$jpeg_sharpen_sigma = Shared::get_option( 'jpeg-sharpen-thumbnails', Shared::jpeg_sharpen_thumbnails_default() );
								0 === $jpeg_sharpen_sigma || $this->image->sharpenImage( 0, $jpeg_sharpen_sigma / 10.0 );
							}
						}
