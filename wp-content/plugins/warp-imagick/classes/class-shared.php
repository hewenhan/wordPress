...
if ( ! class_exists( __NAMESPACE__ . '\Shared' ) ) {
	...
	# region Plugin Instance Services
		 ...
		 */
		public static function webp_clone_image( $source_image, $mime_type = '' ) {
			$plugin = self::plugin( 'webp_clone_image' );
			if ( $plugin ) {
				return $plugin->webp_clone_image( $source_image, $mime_type );
			}
			return false;
		}
	...
	# region Option/Settings defaults and ranges min/max values.
		...
		public static function jpeg_sharpen_image_default() {
			return 0;
		}

		/** Get jpeg sharpen thumbnails default. */
		public static function jpeg_sharpen_thumbnails_default() {
			return 0;
		}

		/** Get png sharpen thumbnails default. */
		public static function png_sharpen_thumbnails_default() {
			return 0;
		}
		...
		/** Get default BIST disabled (true). */
